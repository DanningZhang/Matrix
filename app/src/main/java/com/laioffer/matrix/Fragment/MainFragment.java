package com.laioffer.matrix.Fragment;
...
import com.laioffer.matrix.Adapter.ReportRecyclerViewAdapter;
...
public class MainFragment extends Fragment implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        //Declare report button behavior
    ...
    private void showDiag() {
        ...
        //set up clickListener for back button
    ...
    private void setupRecyclerView(View dialogView) {
        ...
        //pass OnItemClickListener implementation to RecyclerViewAdapter
        mRecyclerViewAdapter.setItemClickListener(new ReportRecyclerViewAdapter
                .OnItemClickListener() {
            @Override
    ...
    /**
        Set up Event details and button clickListener
     */
    ...
    //Upload event to FirebaseDatabase
    ...
    private void uploadImage(final String key) {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                //Save downloadUrl to corresponding event object
                database.child("events").child(key).child("imgUri").
                        setValue(downloadUrl.toString());
                //Find and delete local image file
                File file = new File(path);
                file.delete();
                dialog.dismiss();
                loadEventInVisibleMap();
    ...
    private void setupBottomBehavior() {
        ...
        final View bottomSheetView = (View) mView.findViewById(R.id.bottomSheetView);
